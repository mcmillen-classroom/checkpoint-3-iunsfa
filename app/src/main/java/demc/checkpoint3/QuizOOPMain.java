...
public class QuizOOPMain
{
    ...
    public static void main(String[] args)
    {
        ...
        String[] Question4 = new String[]{"Lord Moriarty", "Count Dracula", "Voldemort", "Darth Vader"};
        ...
        questions[4] = new MultipleChoiceQuestion("Who is the main antagonist in Sherlock Holmes?",Question4,0);
